...
\begin{IEEEkeywords}
SIMD, AVX512, Knight's Landing, Tridiagonal, Matrix, Thomas Algorithm, Layout, Indexing
\end{IEEEkeywords}
...
The total tile size parameter sweep mostly supports our prediction that 
  performance drops from tile sizes that fit into a particular cache to tile
  sizes that do not.
