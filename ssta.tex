...
%      Each tile consists of \((ni/2)(nk)\) contiguous \(i\)-rows (colored
...
%        below), each containing \((ni/2)(nk)\) elements.
      This layout and tiling combination exhibits greater contiguity
