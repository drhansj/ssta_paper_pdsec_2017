...
contiguous region accessed might be less than the smallest page size availble
...
Once we came to understand that the root of this problem was the non-contiguous
nature of our tiles, we searched for a way to formulate a contiguous tiling
scheme. We soon realized that the problem was that we had decided that the
