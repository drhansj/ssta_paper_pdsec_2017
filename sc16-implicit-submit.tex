...
\begin{figure}[!bt]
    ...
    \subfloat[
        ...
        \includegraphics[width=0.33\linewidth]{figures/post_tsb_impact_of_optimizations_histogram_carl_knl_7210_1pus.pdf}
        \label{fig:r0c2}
    }
    \hspace{0mm}
    \label{fig:r1}
    ...
    \subfloat[
        ...
        \includegraphics[width=0.33\linewidth]{figures/post_tsb_impact_of_optimizations_histogram_carl_knl_7210_64pus.pdf}
        \label{fig:r1c2}
    }
\end{figure}
\end{landscape}
