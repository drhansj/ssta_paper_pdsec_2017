...
\begin{figure*}[!bth]
  ...
  \begin{minipage}{0.49\textwidth}
    \centering
    \caption{
      \textbf{Total Tile Size vs Effective Bandwidth (Ivy Bridge)} \fxnote{Lorem ipsum}
    }
  ...
  \begin{minipage}{0.49\textwidth}
    \centering
    \caption{
      \textbf{Total Tile Size vs Effective Bandwidth (Haswell):} \fxnote{Lorem ipsum}
    }
...
\begin{figure*}[!bth]
  ...
  \begin{minipage}{0.49\textwidth}
    \centering
    \caption{
      \textbf{Total Tile Size vs Effective Bandwidth (Knight's Landing):} \fxnote{Lorem ipsum}
    }
  ...
  \begin{minipage}{0.49\textwidth}
    \centering
    \caption{
      \textbf{\% of STREAM Triad Effective Bandwidth:} \fxnote{Lorem ipsum}
    }
